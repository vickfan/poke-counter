...
import { damageActive, STEPS, type PlayerState } from './player'
...
export default function App() {
  ...
  const confirmTopAttack = () => {
    setState((s) => ({
      ...s,
      bottom: damageActive(s.bottom, STEPS[s.top.stepIndex]),
    }))
  }

  const confirmBottomAttack = () => {
    setState((s) => ({
      ...s,
      top: damageActive(s.top, STEPS[s.bottom.stepIndex]),
    }))
  }
    ...
    <div className="app">
      <section className="half half--rotated half--red" aria-label="Player top">
        <PlayerHalf
          ...
          onChange={setTop}
          onFlip={startFlip}
          onConfirmAttack={confirmTopAttack}
        />
      </section>
      ...
      <section className="half half--blue" aria-label="Player bottom">
        <PlayerHalf
          ...
          onChange={setBottom}
          onFlip={startFlip}
          onConfirmAttack={confirmBottomAttack}
        />
      </section>
      {flip ? (
        <CoinFlip
